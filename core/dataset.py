    ...
    def __next__(self):
        with tf.device('/cpu:0'):
            ...
            batch_label_lbbox = np.zeros((self.batch_size, self.train_output_sizes[2], self.train_output_sizes[2],
                                          self.anchor_per_scale, 6 + self.num_classes))
            # Changed here --->
            batch_sbboxes = np.zeros((self.batch_size, self.max_bbox_per_scale, 5))
    ...
    def preprocess_true_boxes(self, bboxes):        
        ...
        for bbox in bboxes:
            ...
            if not exist_positive:
                ...
                label[best_detect][yind, xind, best_anchor, 4:5] = bbox_theta
                ...
                # Changed here -->
                bboxes_xywh[best_detect][bbox_ind, 4] = bbox_theta
